...
<dl>
  <dt>我的账户</dt>
  <dd id="chongzhi"><a href="${pageContext.request.contextPath}/toRecharge.jsp">充值</a><span></span></dd>
  <dd id="wodexinxi"><a href="${pageContext.request.contextPath}/myAccount.jsp">我的信息</a><span></span></dd>
