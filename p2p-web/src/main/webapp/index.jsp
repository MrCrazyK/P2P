	...
	<div class="registerBody">
		...
		<c:choose>
			<c:when test="${empty user}">
				...
				<div class="register">
					<h3>动力金融网历史年化收益率</h3>
					<h4><span id="avg">${historicalAverageRate}</span>%</h4>
					<div class="bn_register"><a href="register.jsp" class="btn-1">注册领888大红包</a></div>
...
<div class="brand-promotion">
	...
	<div class="mainBox">
		...
		<div class="jinxin-data">
			<h3>平台用户数</h3>
			<div class="data"><span id="hzxx_ljrs">${userCount}</span>位</div>
			<div class="line"></div>
			<h3>累计成交额</h3>
			<div class="data"><span id="hzxx_ljje">${bidMoneySum}</span>元</div>
		</div>
	</div>
</div>
<!--品牌宣传end-->
