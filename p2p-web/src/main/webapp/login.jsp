      ...
      <div class="login-cnt clearfix">
        ...
        <div class="login-right">
          ...
          <div class="top-txt">
		          动力金融网，便捷的投资平台
			<br/><br/>
			加入动力金融网<br/>坐享<span class="historicalAverageRate">--</span>历史年化收益
          </div>
           
          <div class="currently">
          	平台用户数：<span id="userCount">--</span>位，累计成交额： <span id="bidMoneySum">--</span>元
          </div>
          ...
          <div class="bn-reg" id="quickRegBtn">
           ...
           <ul class="clearfix">
            <li><i></i>
              <h3>优选投资计划</h3>
              <p>
              	历史年化收益<span class="historicalAverageRate">--</span><br/>
